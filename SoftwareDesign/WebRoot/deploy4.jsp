...
<html>
  ...
  <body background="images/mypic/mainbackground.jpg">
   <% 
     ...
     stmt.execute("update employeeInfo set position='"+position+"',department='"+department+"' where Eid="+Eid+"");
    ...
    while( resultSet2.next( ) ) 
        ...
        stmt1.execute("update chart set num="+num+" where degree='"+department+"'");//修改新部门的人数相应加一         
   ...
   <br>
    ...
    <table bgcolor="grey" border=1 width=1000 border=1 width=1000>
       ...
       <%
		...
		%>
		       <td><a href="deploy.jsp?Eid=<%=rs.getString("Eid")%>">离退</a> <a href="deploy2.jsp?Eid=<%=rs.getString("Eid")%>">调配</a></td>
		<% 
     ...
     <br>
        <br>
        <h3><a href="people_deploy.jsp"> <font color="white">返回人员调配页面</font></a></h3>
  </body>
</html>
